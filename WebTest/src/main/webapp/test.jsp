				...
				<td data-group="checkFail">
					...
					<form name="ck" method="get">
						...
						KT<input type="checkbox"
							name="ck" value="KT" onclick='checkOnlyOne(this)' /> 
						LG<input
							type="checkbox" name="ck" value="LG" onclick='checkOnlyOne(this)' />
						알뜰<input type="checkbox" name="ck" value="ck"
							onclick='checkOnlyOne(this)' /> <select name="ck">
							<option value="ck">=== 선택 ===</option>
							<option value="알뜰SK">알뜰 SK</option>
							<option value="알뜰KT">알뜰  KT</option>
							<option value="알뜰LG">알뜰 LG</option>
						</select>
						<tr>
							<th>전화번호:</th>
